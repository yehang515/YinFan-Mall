package com.yinfan.oauth.controller;

import com.yinfan.oauth.service.LoginService;
import com.yinfan.oauth.util.AuthToken;
import com.yinfan.oauth.util.CookieUtil;
...
public class UserLoginController {
    ...
    public Result<Map> login(String username, String password) {
        String code = new BCryptPasswordEncoder().encode("heima");
